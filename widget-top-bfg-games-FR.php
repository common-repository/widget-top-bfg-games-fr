<?php
/*  Copyright 2008-2011 Denis "Mr.Snow" Kozhukhov  (email : mrsnow@chocosnow.com), ChocoSnow.com, ChocoSnow.fr
...
/*
Plugin Name: Widget Top BFG Games FR
Plugin URI: http://www.chocosnow.fr/blog/widget-bfg-top-games/
Description: Ce plugin est simple: un widget qui affiche une FR (Franch, .fr) liste des meilleurs jeux à partir de votre barre latérale BigFish widgetized. ENGLISH: This simple plugin is a widget that displays a FR (Franch, .fr) list of top casual games from BigFish on your widgetized sidebar.
Author: <a href="http://www.chocosnow.com/">ChocoSnow.com</a>, <a href="http://www.chocosnow.fr/">ChocoSnow.fr</a>, <a href="http://www.mrsnow.info/">Denis "Mr.Snow" Kozhukhov</a>
...
function widget_mrsnow_bfgtopgames_FR_work ($before, $after)
{
	$options = (array) get_option ('widget_mrsnow_bfgtopgames_FR');
	if ($options['channel']==null) 
	{
		$options['channel'] = str_replace ('.', '', str_replace ('_', '', str_replace ('-', '', $_SERVER['HTTP_HOST'])));
		update_option ('widget_mrsnow_bfgtopgames_FR', $options);
	};
	...
	$md5 = hash ("md5", $url);
	$options2 = $newoptions2 = get_option ('widget_mrsnow_bfgtopgames_FR_'.$md5);
	...
	if ($options2['csurl'] == '') 
	{
		...
		else if ($variant == 1)
		{
			...
			if ($lang=='jp') 
				...
				$newoptions2['csurl'] = $csurl[$lang].GenerateIdFromTitle_FR ($variantTitle).'/';
		...
		if ($options2 != $newoptions2) 
		{
			...
			update_option ('widget_mrsnow_bfgtopgames_FR_'.$md5, $options2);
		};
	};	
...
function GenerateIdFromTitle_FR ($title)
{
...
function widget_mrsnow_bfgtopgames_FR_control () 
{
	$text['title'] = 'Widget Titre:';
	$text['titled'] = 'Top Jeux BigFish';
	$text['gnum'] = 'Nombre de Jeux d\'affichage:';
	$text['gtype'] = 'Jeux type d\'affichage:';
	$text['gtypep'] = 'Jeux PC';
	//$text['gtypem'] = 'Mac Games (English sites only)';
	$text['gtypeo'] = 'Jeux en ligne';
	//$text['glang'] = 'Games Language to Display:';
	$text['align'] = 'Texte et images Aligner:';
	$text['alignd'] = 'Thème par défaut';
	$text['alignr'] = 'Droite';
	$text['alignl'] = 'Gauche';
	$text['alignc'] = 'Centre';
	$text['bullets'] = 'Voir la liste des balles';
	$text['pos'] = 'Voir les jeux de position';
	$text['img'] = 'Jeux Voir les images';
	$text['imgtype'] = 'Type d\'images:';
	$text['imgtypes'] = 'Petits (60x40)';
	$text['imgtyped'] = 'Par défaut (80x80)';
	$text['imgtypef'] = 'Feature (175x50)';
	$text['imgtypesf'] = 'Subfeature (175x50)';
	$text['showt'] = 'Voir le texte des jeux';
	$text['titlepos'] = 'Titre du poste:';
	$text['titleposti'] = 'Titre dessus de l\'image';
	$text['titleposit'] = 'Titre image ci-dessus';
	$text['bfglogin'] = 'Votre <a href="http://affiliates.bigfishgames.com/index.html?afcode=af6e89e0ae1a">BigFishGames affilié</a> connexion:';
	$text['bfgloginnb'] = 'Vous pouvez laisser ce champ vide, <br/> widget peut travailler sans connexion, ou utiliser <br/> connexion correcte.';
	$text['bfgchan'] = 'Canal BigFishGames clients affiliés:';
	$text['bfgchannb'] = 'Le nom de domaine sera utilisé par défaut. <br/> Laissez ce champ vide, de ne pas utiliser les canaux. <br/> S\'il vous plaît utilisez alphanumériques uniquement.';
	$text['copy'] = 'Copyright 2008-2011 par <a href="http://www.chocosnow.fr/">ChocoSnow.fr</a>';

	$options = $newoptions = get_option ('widget_mrsnow_bfgtopgames_FR');
	...
	$options['lang'] = $options['lang'] ? $options['lang'] : 'fr';
...
function widget_mrsnow_bfgtopgames_FR_init () 
{	
	...
	function widget_mrsnow_bfgtopgames_FR ($args) 
	{
		extract ($args);
		//$start = mrsnow_microtime_float ();
		//echo $before_widget;
		echo "\n".'<!-- Widget Top BFG Games FR: START -->'."\n";
		echo widget_mrsnow_bfgtopgames_FR_work ($before_title, $after_title);
		echo "\n".'<!-- Widget Top BFG Games FR: END -->'."\n";
		//echo $after_widget;
	...
	register_sidebar_widget (array ('Widget Top BFG Games FR', 'widgets'), 'widget_mrsnow_bfgtopgames_FR');
	register_widget_control (array ('Widget Top BFG Games FR', 'widgets'), 'widget_mrsnow_bfgtopgames_FR_control');
};

// Delay plugin execution to ensure Dynamic Sidebar has a chance to load first
add_action ('widgets_init', 'widget_mrsnow_bfgtopgames_FR_init');
